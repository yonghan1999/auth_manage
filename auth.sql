...
-- ----------------------------
INSERT INTO `t_role`
VALUES (1, 'ROLE_admin', '/api/**');
INSERT INTO `t_role`
VALUES (2, 'ROLE_default', '/api/app/**');
...
CREATE TABLE `t_app`  (
                          `id` int(11) NOT NULL AUTO_INCREMENT,
                          `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '应用名：com.example.demo',
                          `current_version` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '例如：0.0.1',
                          `current_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '例如：20220703',
                          `support_version` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '最低支持版本，例如：0.0.1',
                          `support_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '最低支持版本，例如：20220703',
                          `create_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
                          PRIMARY KEY (`id`) USING BTREE,
                          INDEX `create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

INSERT INTO `auth`.`t_app` (`name`, `current_version`, `current_code`, `support_version`, `support_code`, `create_time`) VALUES ('admin', '0.0.1', '20220830', '0.0.1', '20220830', '2022-08-30 16:05:38');
